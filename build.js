...
const formats = {
  'android': {
    'output': [`<?xml version="1.0" encoding="utf-8"?>\n\n${xmlLicense}\n<resources>\n    <!-- AUTOGENERATED Photon Color Palette v${metadata.version} -->\n`],
  ...
  'css': {
    'output': [`${jsLicense}\n/* AUTOGENERATED Photon Colors CSS Variables v${metadata.version} */\n\n:root {\n`],
    'formatter': (color, variant, value, alpha) => {
      if (alpha == '100') {
  ...
  'ios': {
    'output': [`${jsLicense}\n/* AUTOGENERATED Photon Colors iOS Variables v${metadata.version}\n   From ${metadata.homepage} */\nimport UIKit\n\nextension UIColor {\n    struct Photon {\n`],
    'formatter': (color, variant, value, alpha) => {
  ...
  'js': {
    'output': [`${jsLicense}\n/* AUTOGENERATED Photon Colors JS Variables v${metadata.version} */\n\n`],
    'formatter': (color, variant, value, alpha) => {
      if (alpha != '100') {
        variant += `_A${alpha}`;
  ...
  'less': {
    'output': [`${jsLicense}\n/* AUTOGENERATED Photon Colors Less Variables v${metadata.version} */\n\n`],
    'formatter': (color, variant, value, alpha) => {
      if (alpha == '100') {
        return `@${color}-${variant}: ${value};\n`;
      } else {
  ...
  'sass': {
    'output': [`${jsLicense}\n/* AUTOGENERATED Photon Colors SCSS Variables v${metadata.version} */\n\n`],
    'formatter': (color, variant, value, alpha) => {
      if (alpha == '100') {
        return `$${color}-${variant}: ${value};\n`;
      } else {
